...
def draw_network_info(parameters):
...
def brain_analyser():
    ...
    while True:
        ...
        draw_network(
            layers={'1': [1, 2], '2': [5], '3': [4], '4': [3]},
            connections={'1|4': [False, 3.251], '1|5': [True, 5.123], '5|4': [True, 2.152], '2|4': [True, 1.321], '4|3': [True, 1.742]},
            neurons={'1': [1], '2': [1], '3': [0], '4': [0], '5': [0]}
        )
